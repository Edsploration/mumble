...
Valid options are:
  ...
  --locale &lt;locale&gt;
        ...
        <translation>Bruk: mumble [innstilling] [&lt;nettadresse&gt; | &lt;programtilleggsliste&gt;]

&lt;nettadresse&gt; angir en nettadresse å koble til etter oppstart, istedenfor visning av
tilkoblingsvinduet, og har følgende form:
mumble://[&lt;brukernavn&gt;[:&lt;passord&gt;]@]&lt;vert&gt;[:&lt;port&gt;][/&lt;kanal&gt;[/&lt;underkanal&gt;...]][?versjon=&lt;x.y.z&gt;]

&lt;programtilleggsliste&gt; er en liste over programtilleggsfiler som skal installeres
Versjonsspørringsparameteret må være satt for å bringe til veie rett versjonsnummer
Det er som forvalg satt til 1.2.0 per nå.

Mulige innstillinger:
  -h, --help    Vis denne hjelpeteksten og avslutt.
  -m, --multiple
                Tillat at flere instanser av klienten starter.
  -c, --config
                Angi en alternativ oppsettsfil.
                Hvis du bruker dette til å kjøre flere instanser av Mumble samtidig,
                må du huske å sette en alternativt «database«-verdi i oppsettet.
  --default-certificate-dir &lt;dir&gt;
                Angi en alternativ forvalgt sertifikatssti.
                Denne stien brukes kun hvis det ikke er noe innlastet sertifikat
                fra innstillingene.
  -n, --noidentity
                Undertrykk innnlasting av identitetsfiler (f.eks. sertifikater.)
  -jn, --jackname &lt;arg&gt;
                Sett egendefinert Jack-klientnavn.
  --license
                Vis Mumble-lisensen.
  --authors
                Vis Mumble-utviklerne.
  --third-party-licenses
                Vis lisenser for tredjepartsprogramvare brukt av Mumble.
  --window-title-ext &lt;arg&gt;
                Setter egendefinert vindustittel-utvidelse.
  --dump-input-streams
                Dump PCM-lydstrømmer i forskjellige deler av inngangskjeden
                (nyttig i avlusingsøyemed)
                - rå mikrofoninndata
                - returnert høyttalerlyd for ekko-kansellering
                - behandlet mikrofoninndata
  --print-echocancel-queue
                Skriv tilstand for ekko-kanselleringskø til stdout
                (nyttig i avlusingsøyemed)
  --translation-dir &lt;dir&gt;
                Angir en ytterligere oversettelsesfil &lt;dir&gt; der
                Mumble søker etter oversettelsesfiler som overskrives
                de innebygde
                Mapper lagt til på denne måten har høyere prioritet enn de
                forvalgte som ellers brukes
  --print-translation-dirs
                Skriv ut stiene Mumble søker etter oversettelsesfiler i
                som overskriver de innebygde.
                (Nyttig for oversettettere som vil teste sine oversettelser)
  --locale &lt;locale&gt;
                Overskriv lokalitet brukt i Mumble-innstillingene med en
                som samsvarer med angitt lokalitetsstreng.
                Hvis formatet er ugyldig vil Mumble vise en feil.
                Ellers vil lokalitetsvalget lagres i Mumble-innstillingene.
</translation>
    </message>
    <message>
